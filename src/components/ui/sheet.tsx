  ...
  'fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
        ...
        right:
          'inset-y-0 right-0 h-full w-full border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:w-[420px] sm:max-w-[420px]',
      },
    },
    defaultVariants: {
      side: 'right',
...
>(({ side, className, children, ...props }, ref) => {
  const sheetSide: NonNullable<SheetContentProps['side']> = side ?? 'right';
